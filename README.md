...
## 作用
使用 bitnami elasticsearch chart 时 `analysis-ik` 官方下载的文件名不符合 container 脚本要求导致安装插件失败 [issue link](https://github.com/bitnami/charts/issues/25280)，使用这个代理可以重命名下载文件名。
